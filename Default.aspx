<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="online.Default" %>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                 <div class="course-item bg-light">
                        ...
                        <div class="text-center p-4 pb-0">
                           ...
                           <a href="singlecourse.aspx?slug=<%=db.reader["slug"] %>"> <h5 class="mb-4"><%=db.reader["coname"] %></h5></a>
                        </div>
